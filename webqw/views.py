...
def qw_automation(request, page_id):
	...
	for appid in user_app_lst:
		app_id_lst.append(appid.app_id_id)
	if 7 in app_id_lst:
		return render(request, 'qw_automation.html',{'business_lst': business_lst,'user_id':user_id,'user_app_lst':user_app_lst, 'app_lst': app_lst,'businame':'Webqw','app_name':"webqw性能对比自动化",'li':data,'page_str':page_str})
	else:
